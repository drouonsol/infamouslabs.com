...
<div style={{padding:"65px 0px",justifyContent:"space-evenly",textAlign:"center"}}>
  ...
  <div  style={{height: "fit-content",  }}> <div class="container">
            ...
            <a href="https://discord.gg/inflbs" class="card" target="_blank"style={{backgroundImage: "url(https://media.discordapp.net/attachments/890670720705777785/1095238368473907221/C0F68985-ED75-4350-8F76-8C16614014F4.png)"}}>
     ...
     <a href="https://discord.gg/inflbs" class="card" target="_blank" style={{backgroundImage: "url(https://media.discordapp.net/attachments/890670720705777785/1028633293349998643/Untitled_Artwork.png"}}>
         ...
         <div class="content">
          ...
          <a href="https://discord.gg/inflbs" target="_blank" class="button button-arrow bg-stuck2" style={{opacity:"100%"}}>
      MORE&nbsp;
